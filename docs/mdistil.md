...
The solver parameters (mass,M5,CGPrecision,MaxIter) have to be supplied for the inversion of the Dirac matrix. The noises are generated by a unique string which is compound of the gauge field used and the mass given to the solver.
